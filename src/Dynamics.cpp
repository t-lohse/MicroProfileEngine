...
namespace profile {
    ...
    std::variant<size_t, double> Dynamics::find_current_segment(double input) {
    ...
    double Dynamics::runInterpolation(double input) {

        auto v = V {
                    [&](size_t&& v){return points[v].y;},
                    [](double&& v){return v;}
            };
