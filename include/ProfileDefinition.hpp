...
#define ENUM_MAX_BITS(ENUM_TYPE, MAX_ENUM_ENTRY, BITS) ENTRY_MAX_BITS(ENUM_TYPE, ENUM_TYPE::MAX_ENUM_ENTRY, BITS)
...
enum class InputType : uint8_t { INPUT_TIME, INPUT_PISTON_POSITION, INPUT_WEIGHT };
ENUM_MAX_BITS(InputType, INPUT_WEIGHT, 2)

enum class InterpolationType : uint8_t { INTERPOLATION_LINEAR, INTERPOLATION_CATMULL, INTERPOLATION_BEZIER };
